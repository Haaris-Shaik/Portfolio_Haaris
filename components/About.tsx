...
import profilePic from "public/extraImages/profile.png";
    ...
    >
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          with a strong background in machine learning, AI, and web development. I specialize in building data-driven applications, leveraging technologies like Python, TensorFlow, Scikit-Learn, and SQL for analytics, and React, Node.js, and Django for web solutions.
          <br /> <br /> Alongside my tech endeavors, I am an avid reader and
          enjoy writing about my experiences and learnings in my <span className="text-blue-500 font-semibold"><a href="https://learnwithhaaris.wordpress.com/" target="_blank">blogs</a></span>.
        </p>
      </div>
    </motion.div>
  );
